...
public class IfEx02_연습_2 {
	...
	public static void main(String[] args) {
		...
		if 		(com > yourChoice) 					System.out.println("Up");
		else if (com < yourChoice)					System.out.println("Down");
		else if (com == yourChoice)					System.out.println("Bingo");
		else if (yourChoice > 10 && yourChoice < 0) System.out.println("범위 내의 값을 입력하세요");
