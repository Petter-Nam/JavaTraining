...
public class ArrayEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr[0]); // 배열의 요소(elements)에는 초기값이 지정되어있다.
		...
		//at step2_01.array.ArrayEx01.main(ArrayEx01.java:56)
		System.out.println();
		...
		// arr[3] = 지움; 이런것은 존재하지 않는다. 리스트라는 자료를 배우면 사용
		arr[3] = 0;
		arr[4] = 0; //이런식으로 지웠다고 약속한다. 처음상태로 돌려놓는 방법
		
		for (int i = 0; i < arr.length; i++) {
			System.out.println(arr[i]);
		}
		
		// null 대입하여 배열자체를 삭제 할 수 있다.
		arr = null;
