...
CREATE TABLE TEST5 (
    ...
    REG_DT     TIMESTAMP  DEFAULT '2024_04_03'
);
...
CREATE TABLE TEST10_2(
    ...
    MEMBER_ID VARCHAR(20),
    PRODUCT_CD INT,
   	#FOREIGN KEY (PRODUCT_CD) REFERENCES TEST10_1(PRODUCT_CD) # 참조 키 설정
   	CONSTRAINT PRODUCT_CD_REF2 FOREIGN KEY (PRODUCT_CD) REFERENCES TEST10_1(PRODUCT_CD) # 참조 키 설정
   	ON UPDATE CASCADE # 업데이트 참조 옵션 설정 
   	ON DELETE SET NULL # 삭제 참조 옵션 설정
);
