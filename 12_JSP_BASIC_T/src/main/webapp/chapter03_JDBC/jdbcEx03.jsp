	...
	<%
		...
		*/
		...
		try {
			...
			//선처리문 쿼리 완성
			pstmt.setString(1, "P10016"); 		// INSERT INTO PRODUCT VALUES VALUES(P10016, ?, ?, NOW())
			pstmt.setString(2, "게이밍의자");	// INSERT INTO PRODUCT VALUES VALUES(P10016, 게이밍의자, ?, NOW())
			pstmt.setInt(3, 200000);			// INSERT INTO PRODUCT VALUES VALUES(P10016, 게이밍의자, 185000, NOW())
