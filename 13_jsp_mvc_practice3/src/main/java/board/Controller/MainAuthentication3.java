...
@WebServlet("/bAuthen3")
public class MainAuthentication3 extends HttpServlet {
	...
	// 인증화면 달라
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			RequestDispatcher dis = request.getRequestDispatcher("step01_boardEx/bAuthen3.jsp");
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			boolean isAuthenticationUser = BoardDAO3.getInstance().checkAuthenticationUser(boardDTO);
			...
			if (isAuthenticationUser) {
				...
				if (menu.equals("update")) {
					...
					jsScript = "<script>";
					jsScript += "location.href='bUpdate3?boardId=" + boardId + "';";
					jsScript += "</script>";
				}
				// delete버튼을 클릭했으면
					...
					jsScript = "<script>";
					jsScript += "location.href='bDelete3?boardId=" + boardId + "';";
					jsScript += "</script>";
				}
