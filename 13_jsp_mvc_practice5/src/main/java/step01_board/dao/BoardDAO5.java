...
import step01_board.controller.BoardList5;
import step01_board.dto.BoardDTO5;

public class BoardDAO5 {
	private BoardDAO5(){}
	private static BoardDAO5 instance = new BoardDAO5();
	public static BoardDAO5 getInstance () {
		return instance;
	}
	...
	public void InsertBoard(BoardDTO5 boardDTO) {
		try {
			getConnection();
	...
	public ArrayList<BoardDTO5> getBoardList() {
		
		ArrayList<BoardDTO5> boardList = new ArrayList<BoardDTO5>();
	...
	public BoardDTO5 getBoardDetail (long boardId) {
	...
	public boolean checkAuthenticationUser(BoardDTO5 boardDTO) {
		System.out.println("boardDTO checkAuthen: " + boardDTO);
	...
	public void updateBoard(BoardDTO5 boardDTO) {
