...
public class BoardDAO6 {
	
	private BoardDAO6(){}
	private static BoardDAO6 instance = new BoardDAO6();
	public static BoardDAO6 getInstance() {
		return instance;
	}
	...
	public void InsertBoard(BoardDTO6 boardDTO) {
		try {
			getConnection();
	...
	public ArrayList<BoardDTO6> getBoardList() {
		
		ArrayList<BoardDTO6> boardList = new ArrayList<BoardDTO6>();
	...
	public BoardDTO6 getBoardDetail(long boardId) {
...
try {
	...
	public boolean checkAuthenticationUser(BoardDTO6 boardDTO) {
	...
	public void updateBoard(BoardDTO6 boardDTO) {
