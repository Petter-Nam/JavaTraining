...
public class BoardDAO7 {
	...
	private static BoardDAO7 instance = new BoardDAO7();

	public static BoardDAO7 getInstance() {
		return instance;
	}
	...
	public void insertBoard(BoardDTO7 boardDTO) {
		try {
			getConnection();
	...
	public ArrayList<BoardDTO7> getBoardList() {

		ArrayList<BoardDTO7> boardList = new ArrayList<BoardDTO7>();
	...
	public BoardDTO7 getBoardDetail(long boardId) {
	...
	public boolean checkAuthenticationUser(BoardDTO7 boardDTO) {
	...
	public void updateBoard(BoardDTO7 boardDTO) {
