...
public class ControlStatementAnswerSampleController {

	@Autowired
	private SupposeDAO supposeDAO;
	
	@GetMapping("/ex05_answerSample")
	public String ex05_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx05_answerSample";
		
	}

	
	@GetMapping("/ex06_answerSample")
	public String ex06_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx06_answerSample";
		
	}
	
	
	@GetMapping("/ex07_answerSample")
	public String ex07_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx07_answerSample";
		
	}

	
	@GetMapping("/ex08_answerSample")
	public String ex08_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx08_answerSample";
		
	}

	
	@GetMapping("/ex09_answerSample")
	public String ex09_answerSample() {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx09_answerSample";
		
	}
	
	
	@GetMapping("/ex10_answerSample")
	public String ex10_answerSample() {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx10_answerSample";
		
	}
	
	
	@GetMapping("/ex11_answerSample")
	public String ex11_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx11_answerSample";
		
	}
	
	
	@GetMapping("/ex12_answerSample")
	public String ex12_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx12_answerSample";
		
	}
	
	
	@GetMapping("/ex13_answerSample")
	public String ex13_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx13_answerSample";
		
	}
	
	
	@GetMapping("/ex14_answerSample")
	public String ex14_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx14_answerSample";
		
	}
	
	
	@GetMapping("/ex15_answerSample")
	public String ex15_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx15_answerSample";
		
	}
	
	
	@GetMapping("/ex16_answerSample")
	public String ex16_answerSample(Model model) {
		...
		*/
		...
		return "chapter01_thymeleaf/controlStatement/controlEx16_answerSample";
