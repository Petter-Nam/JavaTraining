...
public class ExpressionPractice {
	...
	public String ex04_question(Model model) {
	...
	public String ex05_question(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx05_answerSample";
	...
	public String ex07_question(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx07_question";
	...
	public String ex08_question(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx08_question.html";
		
	}
	
	
	@GetMapping("/ex09_practice")
	public String ex09_question(HttpServletRequest request) {
		...
		return "chapter01_thymeleaf/expression/expressionEx09_question.html";
		
	}

	
	@GetMapping("/ex10_practice")
	public String ex10_question(Model model) {
		...
		return "chapter01_thymeleaf/expression/expressionEx10_question.html";
