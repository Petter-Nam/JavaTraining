...
public class SwaggerController {
	...
	*/
	 ...
	 */
	@Operation(summary = "swagger실습" , description = "swagger실습 튜토리얼입니다.")
	@GetMapping("/operation")
	public String operation() {
		
		System.out.println("--- @Operation ---");
		
		return "operation 실습 튜토리얼";
	...
	@ApiResponses(value={
			...
			@ApiResponse(responseCode="404" , description="잘못된 경로입니다."),
			@ApiResponse(responseCode="405" , description="잘못된 방식입니다."),
			@ApiResponse(responseCode="500" , description="서버오류입니다.")
	})
	...
	// 5) Synthesize
	@Operation(summary = "swagger 종합실습" , description = "swagger 종합실습 튜토리얼입니다.")
	@Parameters({
        @Parameter(name = "전송데이터1" , description = "테스트 문자열" , example = "yyyy-MM-dd"),
        @Parameter(name = "전송데이터2" , description = "테스트 정수" , example = "13579")
	})
