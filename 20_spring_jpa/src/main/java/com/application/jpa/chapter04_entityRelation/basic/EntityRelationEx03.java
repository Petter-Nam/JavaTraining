...
public class EntityRelationEx03 {
	...
	private String d1;  // 문자열 예시1 (length 속성 생략시 기본값 : 255)
	
	@Column(length = 10) // length속성은 문자열에만 적용가능하다.
	private String d2;	 // 문자열 예시2
	
	@Lob
	private String d3;  // 문자열 예시3 (BLOB , CLOB)
	...
	@Transient
	private String h;	// @Transient 예시 (테이블 반영x)
