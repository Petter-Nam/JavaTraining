...
import com.application.modudeal.user.service.MemberService;
...
public class UserController {
	...
	@ResponseBody
	public String updateEmail(@ModelAttribute MemberDTO memberDTO) {
	    // 이메일과 전화번호를 업데이트합니다.
	    boolean contactUpdated = memberService.updateEmail(memberDTO);
